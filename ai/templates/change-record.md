...
Use inline in a PR/completion note for `LOW` Knowledge Impact. Keep it brief.

- **Outcome:** what changed for the product/system.
...
Do not include raw logs, transcripts, or speculative rationale.
